...
router.get('/terms', isStaff, academicController.getTerms);
...
router.get('/classes', isStaff, academicController.getClasses);
router.get('/classes/:id', isStaff, academicController.getClass);
