...
style: |
  section { font-family: 'Segoe UI', system-ui, sans-serif; font-size: 24px; }
  h1 { color: #0f172a; font-size: 2.2rem; }
  h2 { color: #1d4ed8; border-bottom: 2px solid #e2e8f0; padding-bottom: 0.3rem; font-size: 1.8rem; }
  li { font-size: 1.1rem; line-height: 1.5; margin-bottom: 0.6rem; }
---
...
4. **M-Pesa FinTech Integration:** Parents pay fees via an STK push
...
- **Estimated Budget:** KES 99,000 (Covers development workstation, testing smartphones, cloud hosting environments, and ISPs).
- **Project Timeline:**
