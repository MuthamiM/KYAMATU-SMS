...
const MatunduBot = () => {
    ...
    const [chatHistory, setChatHistory] = useState([
        { role: 'bot', content: "Hello! I'm MatunduAI, your school assistant. How can I help you today? I can help you plan your tasks or set reminders." }
    ]);
    ...
    useEffect(() => {
        ...
        window.addEventListener('OPEN_MATUNDUBOT', handleOpenBot);
        window.addEventListener('OPEN_KYAMABOT', handleOpenBot);
        return () => {
            window.removeEventListener('OPEN_MATUNDUBOT', handleOpenBot);
            window.removeEventListener('OPEN_KYAMABOT', handleOpenBot);
        };
    }, []);
    ...
    const handleSend = async (e) => {
        ...
        try {
            ...
            toast.error('Failed to get a response from MatunduAI');
        } finally {
            setIsLoading(false);
        }
    };
        ...
        >
            ...
            <div className="bg-[#476C63] p-4 flex items-center justify-between text-white shrink-0">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-bold text-sm tracking-wide">MatunduAI</h3>
                ...
                <>
                    ...
                    <form onSubmit={handleSend} className="p-4 bg-white border-t border-gray-100 mt-auto">
                        ...
                        <p className="text-[9px] text-gray-400 mt-2 text-center font-bold tracking-tight">
                            MatunduAI can help with daily planning & school task reminders.
                        </p>
                    </form>
                </>
            )}
